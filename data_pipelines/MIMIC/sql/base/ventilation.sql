...
, vd1 AS (
    SELECT
        ...
        , CASE
            ...
            -- a 6 hour gap always initiates a new event
            WHEN DATETIME_DIFF(charttime, charttime_lag, HOUR) >= 6 THEN 1
